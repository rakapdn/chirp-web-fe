...
export default function Notifications() {
    ...
    const fetchNotifications = async () => {
      ...
      try {
        ...
        if (error.response?.status === 403) {
          setErrorMessage("Akses ditolak. Anda tidak memiliki izin untuk melihat notifikasi.");
  ...
  const handleProfileClick = (username) => {
    if (username) {
      navigate(`/profile/${username}`); // Lebih RESTful dari query parameter
    }
  };
        ...
        <div className="flex-1 p-6">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 text-sm mt-1">Notifikasi akan muncul ketika ada aktivitas baru.</p>
            </div>
          ) : (
